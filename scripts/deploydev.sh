...
# set some variables
UUID=$(uuidgen)
ROOTDIR=/var/www/vhosts/service-alti/private
DEPLOYDIR=$ROOTDIR/alti
TEMPDIR=$ROOTDIR/alti_temp_$UUID
...
if cd $ROOTDIR; then
  git clone https://github.com/geoadmin/service-alti.git $DEPLOYDIR
else
